...
OSRM_DIR = PROCESSED_DIR / "osrm"
REACHABILITY_DIR = PROCESSED_DIR / "reachability"
REACHABILITY_CHECKPOINT_DIR = REACHABILITY_DIR / "checkpoints"
REACHABILITY_PATH = REACHABILITY_DIR / "cell_reach.parquet"
